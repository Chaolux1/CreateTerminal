...
public class CreateTerminalPonderPlugin implements PonderPlugin {
    private static final ResourceLocation STOCK_TICKER=ResourceLocation.fromNamespaceAndPath("create","high_logistics/stock_ticker");
    ...
    public void registerScenes(PonderSceneRegistrationHelper<ResourceLocation> ponderSceneRegistrationHelper) {
        PonderSceneRegistrationHelper<Item> itemPonderSceneRegistrationHelper=ponderSceneRegistrationHelper.withKeyFunction(BuiltInRegistries.ITEM::getKey);
